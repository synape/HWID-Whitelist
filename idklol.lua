...
local whitelistednigerians = loadstring(game:HttpGet("https://raw.githubusercontent.com/Tanshu334/PaidV4ForRoblox/main/CustomModules/687224481.lua", true))()
local injected = true
...
local OnyxWarePaid = GuiLibrary.CreateWindow({
	["Name"] = "OnyxWarePaid", 
	["Icon"] = "vape/assets/OnyxWarePaidIcon.png", 
	["IconSize"] = 16
})
...
GUI.CreateButton({
	["Name"] = "OnyxWarePaid", 
	["Function"] = function(callback) OnyxWarePaid.SetVisible(callback) end, 
	["Icon"] = "vape/assets/OnyxWarePaidIcon.png", 
	["IconSize"] = 16
})
GUI.CreateButton({
